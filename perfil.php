...
<body>
    ...
    <form action="cadastro.html" method="post" onsubmit="return validarNome() && validarUsuario() && validarEmail() && validarSenha() && validarCPF(document.getElementById('numero').value)">
        ...
        <input placeholder="10240164989" type="text" id="numero" name="numero" maxlength="11" pattern="[0-9]*" oninput="this.value = this.value.replace(/\D/g, '')" class="barra">

        <input placeholder="80230080" type="text" id="cep" name="cep" maxlength="8" pattern="[0-9]*" oninput="this.value = this.value.replace(/\D/g, '')" onblur="buscarCep()" class="barra">

        <input placeholder="Rua Vinte e Quatro de Maio" type="text" id="logradouro" name="logradouro" class="barra">

        <input placeholder="420" type="text" id="numero" name="numero" pattern="[0-9]*" oninput="this.value = this.value.replace(/\D/g, '')" class="barra">
